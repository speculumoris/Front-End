...
public class RunnerSave09 {
    ...
    public static void main(String[] args) {
        ...
        // CascadeType dan dolayı @OneToMany ilişkinin kurulabilmesi için
        // 2 tarafdan objeleri setlememiz gerekiyor
